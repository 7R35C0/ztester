...
pub fn main() !void {
    ...
    print("\n//+=========================================================", .{});
    {
        ...
        list.insertAfter(&nod4, &nod3);
        list.insertAfter(&nod3, &nod4);
        list.insertAfter(&nod0, &nod0);
        list.insertAfter(&nod0, &nod2);
        list.insertAfter(&nod0, &nod4);
